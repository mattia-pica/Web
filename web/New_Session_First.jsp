...
<%@ page import="Bean.Accademic_Year" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<!-- Si dichiara la variabile loginBean e istanzia un oggetto LoginBean -->
<jsp:useBean id="accademiYear" class="Bean.Accademic_Year" scope="session"/>
    ...
    <div class="container-table100">
                ...
                <div class="table100-body js-pscroll" style="overflow:auto;">
                    <table id="table" style="table-layout: fixed">
                        ...
                        <%
                            ...
                            ArrayList<Accademic_Year> y = controller.showYears();

                            for (Accademic_Year aY : y) {%>
       ...
       <%-- <form action="" method="post" class="login100-form validate-form">
            ...
            <div class="wrap-input100 validate-input m-b-18" data-validate ="DataStart">
                ...
                <input class="input100" type="text" name="dataInizio" placeholder="Enter Session start data in format dd/MM/yyyy">
                <span class="focus-input100"></span>
            </div>

            <div class="wrap-input100 validate-input m-b-18" data-validate ="DataEnd">
                <span class="label-input100">Data Fine</span>
                <input class="input100" type="text" name="dataFine" placeholder="Enter Session end data in format dd/MM/yyyy">
                <span class="focus-input100"></span>
            </div>

            <div class="container-login100-form-btn">
                <button class="login100-form-btn" type="submit" name="submit_session" value="Open">
                    Apri Sessione
                </button>
            </div>
        </form>--%>
